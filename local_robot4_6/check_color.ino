...
void check_box()
  {
    for(int i=0; i<3; i++)
      {
        if(my_tcs('r') >= boxcolor_red[0] - 0.25 && my_tcs('r') <= boxcolor_red[0] + 0.25 
        &&my_tcs('g')>= boxcolor_red[1] - 0.25 && my_tcs('g') <= boxcolor_red[1] + 0.25
        &&my_tcs('b')>= boxcolor_red[2] - 0.25 && my_tcs('b') <= boxcolor_red[2] + 0.25)
        {
          Serial.println("red");
          //bz(100); delay(100);
          rgb(0, 0, 1);
      ...
      else if(my_tcs('r') >= boxcolor_green[0] - 0.25 && my_tcs('r') <= boxcolor_green[0] + 0.25 
        &&my_tcs('g')>= boxcolor_green[1] - 0.25 && my_tcs('g') <= boxcolor_green[1] + 0.25
        &&my_tcs('b')>= boxcolor_green[2] - 0.25 && my_tcs('b') <= boxcolor_green[2] + 0.25)
        {
      ...
      else if(my_tcs('r') >= boxcolor_yello[0] - 0.25 && my_tcs('r') <= boxcolor_yello[0] + 0.25 
        &&my_tcs('g')>= boxcolor_yello[1] - 0.25 && my_tcs('g') <= boxcolor_yello[1] + 0.25
        &&my_tcs('b')>= boxcolor_yello[2] - 0.25 && my_tcs('b') <= boxcolor_yello[2] + 0.25)
        {
