...
void stR_can1_to_MD()
  {
    ...
    if(tmd == 0)
      ...
      fw_2sensor(20, 20, 0.3, 0, "3:4","27", 20);
      fline(0,0,0.3, 10, 'n', 'r',40, "a4", 20);    
  }
...
void stR_can2_to_L()
  {  
    ...
    if(tll == 0)
      ...
      fw_2sensor(30,30,0.5,0,"2:3","a0",10);
     ...
     if(mcp_f(2)> md_mcp_f(2)&&mcp_f(1)> md_mcp_f(1))
      ...
      fw_2sensor(20,20,0.5,0,"1:2","27",30);
...
void stR_can2_to_R()
  {  
    ...
    if(trr == 0)
      ...
      bline(30,30,0.15,0,'c','l',50, "a2", 15);
...
void stR_can2_to_MD()
  {
    ...
    if(tmd == 0)
     ...
     Motor(0, 0); delay(100);
      ...
      do{Motor(60,-20);}while(mcp_f(3) > md_mcp_f(3));delay(20); 
      //do{Motor(70,-20);}while(mcp_f(0) < md_mcp_f(0)); 
